...
const db = new Database('techos.db');
...
async function startServer() {
  ...
  // Equipment
  app.get('/api/equipment/:clientId', authenticate, (req, res) => {
  ...
  app.post('/api/os', authenticate, (req, res) => {
  ...
  app.get('/api/os/:id', authenticate, (req, res) => {
    const os = db.prepare(`
  ...
  app.patch('/api/os/:id/status', authenticate, (req, res) => {
  ...
  // PDF Generation
  app.get('/api/os/:id/pdf', authenticate, (req, res) => {
    const os: any = db.prepare(`
